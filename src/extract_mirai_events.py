...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--split", default="test_subset", help="MIRAI split name.")
    parser.add_argument("--limit", type=int, default=0, help="Maximum MIRAI query rows. Use 0 for full split.")
    parser.add_argument("--query-id", default=None, help="Optional single MIRAI QueryId.")
    parser.add_argument("--output", default=str(REPO_ROOT / "datasets" / "event-input-v1.jsonl"), help="Output event-input-v1 JSONL. Use '-' for stdout.")
    parser.add_argument("--extractor", choices=["rule", "qwen"], default="rule", help="Event extractor backend.")
    parser.add_argument("--max-docs", type=int, default=0, help="Maximum MIRAI documents per query.")
    parser.add_argument("--max-events", type=int, default=0, help="Maximum events per query.")
    parser.add_argument("--max-events-per-doc", type=int, default=0, help="Maximum events retained per document.")
