...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--hidden-dim", type=int, default=None, help="Model hidden dimension. Defaults to train_config.json next to model path, then 128.")
    parser.add_argument("--message-steps", type=int, default=None, help="Model message passing steps. Defaults to train_config.json next to model path, then 3.")
    parser.add_argument("--edge-dim", type=int, default=None, help="Model edge feature dimension. Defaults to train_config.json next to model path, then current dataset schema.")
