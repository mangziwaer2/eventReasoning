...
from forecast_trace_grpo_rewards import _as_batch, _value_at, build_grpo_context, completion_to_text, value_to_log_text
...
class JudgeGRPOReward:
    """Deterministic forecast reward augmented by one frozen Qwen trace judge."""
