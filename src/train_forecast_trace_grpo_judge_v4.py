...
from forecast_trace_judge_reward_v5 import PromptReferenceAuditedJudgeGRPOReward
...
def main() -> None:
    ...
    class ConfiguredReward(PromptReferenceAuditedJudgeGRPOReward):
        def __init__(nself, policy_name: str = "forecast_trace_reward", reward_key: str = "total", error_reward: float = -0.25, **kwargs: Any) -> None:
            super().__init__(
